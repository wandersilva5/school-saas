...
<style>
    ...
    /* Set fixed height for charts containers */
    .card.h-100 {
        height: auto !important;
    }
</style>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Set fixed dimensions for all canvas elements to prevent height loop
        const chartCanvases = document.querySelectorAll('canvas');
        chartCanvases.forEach(canvas => {
            // Force a fixed height on the canvas element
            canvas.style.height = '250px';
            canvas.height = 250;
        });

        // Force container heights to be fixed as well
        ...
        // Create charts with maintainAspectRatio: true to maintain dimensions
        ...
        // Use the same pattern for all other charts
